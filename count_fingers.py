...
#*3. criando o método hands e definindo os valores de detecção de confianção e cofiança de ratreamento
...
while True:
    ...
    results = hands.process(image) # executar o código: python count_fingers.py (ainda não será possível ver os pontos)
